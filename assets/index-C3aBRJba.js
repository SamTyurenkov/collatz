(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const u of i.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&o(u)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();const q="collatz.app",G={startN:27};let I={...G};const z=new Set;function Z(){try{const e=localStorage.getItem(q);if(!e)return;const t=JSON.parse(e);typeof t.startN=="number"&&t.startN>=1&&(I={...G,...t})}catch{}}function tt(){try{localStorage.setItem(q,JSON.stringify(I))}catch{}}function R(){const e=O();z.forEach(t=>t(e))}function et(){Z(),R()}function O(){return{...I}}function nt(e){const t=Math.floor(Number(e));!Number.isFinite(t)||t<1||(I={...I,startN:t},tt(),R())}function k(e){return z.add(e),()=>z.delete(e)}function H(e){const t=Math.floor(Number(e));if(!Number.isFinite(t)||t<1)return[];const n=[t];let o=t;const s=5e5;let i=0;for(;o!==1&&i<s;)o%2===0?o=o/2:o=3*o+1,n.push(o),i++;return n}const st=`<section class="section-start-input" aria-labelledby="start-input-label">
...
`;function ot(e){const t=e.trim();if(t==="")return null;const n=Number(t);return!Number.isFinite(n)||!Number.isInteger(n)||n<1?null:n}function it(e){e.innerHTML=st;const t=e.querySelector("#collatz-start-input"),n=e.querySelector("#start-steps-body");function o(a){return a.replace(/\D+/g,"")}function s(){const a=o(t.value);t.value=a;const c=ot(a);return c!==null?(nt(c),!0):!1}function i(){t.value=String(O().startN)}function u(a){const c=H(a),r=document.createDocumentFragment();for(let l=0;l<c.length;l++){const d=document.createElement("tr");d.innerHTML=`<td>${l}</td><td>${c[l]}</td>`,r.appendChild(d)}n.innerHTML="",n.appendChild(r)}t.addEventListener("input",()=>{s()}),t.addEventListener("change",()=>{s()}),t.addEventListener("keydown",a=>{a.key==="Enter"&&(s(),t.blur())}),t.addEventListener("blur",()=>{s()||i()}),k(a=>{document.activeElement!==t&&(t.value=String(a.startN)),u(a.startN)}),i(),u(O().startN)}const rt=`<section class="section-dual-graph" aria-labelledby="dual-graph-heading">
  ...
  <p>This proves chaotic pattern of "n" value going up and down is stable for any initial odd number.</p>
</section>
`,at=17,_=2500,V=Array.from({length:at},(e,t)=>t+1).filter(e=>e%2===1);function lt(e){let t=0,n=e;for(;n*2<=_;)n*=2,t++;return t}const U=Math.max(...V.map(e=>lt(e))),W=52,j=42,D=92,Y=42,J=8,E=[];for(let e=0;e<V.length;e++){let n=V[e],o=0;for(;n<=_;)E.push({value:n,level:o,x:W+e*D,y:j+(U-o)*Y}),n*=2,o++}const S=new Set(E.map(e=>e.value)),N=Object.fromEntries(E.map(e=>[e.value,[e.x,e.y]])),ut=W*2+(V.length-1)*D,ct=j*2+U*Y,L={minX:Math.min(...E.map(e=>e.x)),maxX:Math.max(...E.map(e=>e.x)),minY:Math.min(...E.map(e=>e.y)),maxY:Math.max(...E.map(e=>e.y))};function P(e){let t=e;for(;t%2===0;)t/=2;return t}function dt(e){if((e-1)%3!==0)return null;const t=(e-1)/3;return!Number.isInteger(t)||t<=1||t%2===0?null:t}function ht(e){const t=new Map([[1,[]]]),n=new Map([[1,null]]),o=new Map([[1,0]]),s=[1];let i=0;for(;i<s.length;){const f=s[i++],b=[],w=f*2;w<=e&&b.push(w);const x=dt(f);x!==null&&x<=e&&b.push(x),b.sort((v,X)=>v-X),t.set(f,b);for(const v of b)n.has(v)||(n.set(v,f),o.set(v,o.get(f)+1),t.has(v)||t.set(v,[]),s.push(v))}const u=new Map;for(const[f,b]of o.entries())u.has(b)||u.set(b,[]),u.get(b).push(f);for(const f of u.values())f.sort((b,w)=>b-w);const a=Math.max(...o.values()),c=Math.max(...Array.from(u.values(),f=>f.length-1)),r=36,l=34,d=46,h=26,g=r*2+a*d+Math.max(0,c)*h,p=l*2+a*52,y=new Map,A=Array.from(n.keys()),T=Math.max(...A),B=Math.max(1,p-l*2);for(const[f,b]of u.entries())for(let w=0;w<b.length;w++){const x=b[w],v=r+f*d+w*h,X=p-l-x/T*B;y.set(x,[v,X])}for(const f of A){if(y.has(f))continue;const b=o.get(f),w=r+b*d,x=p-l-f/T*B;y.set(f,[w,x])}return{nodes:A,depthByNode:o,childrenByNode:t,parentByNode:n,positions:y,width:g,height:p}}const m=ht(_),C=m.positions,$=new Set(m.nodes);function pt(){const e=[];for(const t of S){const n=t*2;S.has(n)&&e.push([t,n])}return e}function gt(){const e=[];for(const t of S){if(t%2===0)continue;const n=3*t+1;S.has(n)&&P(n)!==P(t)&&e.push([t,n])}return e}const ft=pt(),bt=gt();function mt(e){const t=[];for(let n=0;n<e.length-1;n++){const o=e[n],s=e[n+1];S.has(o)&&S.has(s)&&t.push([o,s])}return t}function yt(e){const t=[];for(let n=0;n<e.length-1;n++){const o=e[n],s=e[n+1];!$.has(o)||!$.has(s)||(m.parentByNode.get(o)===s||m.parentByNode.get(s)===o)&&t.push([o,s])}return t}function wt(e){const t=new Map;for(let n=0;n<e.length;n++){const o=e[n];t.has(o)||t.set(o,n)}return t}function F(e,t){for(let n=0;n<e.length;n++)if(t.has(e[n]))return n;return-1}function M(e,t,n,o,s){const i=document.createElementNS("http://www.w3.org/2000/svg","line");return i.setAttribute("x1",String(e)),i.setAttribute("y1",String(t)),i.setAttribute("x2",String(n)),i.setAttribute("y2",String(o)),i.setAttribute("class",s),i}function vt(e,t){const n=document.createElementNS("http://www.w3.org/2000/svg","g");n.setAttribute("class","dual-graph-nodes");const o=Array.from(e).sort((s,i)=>{const u=m.depthByNode.get(s)??0,a=m.depthByNode.get(i)??0;return u!==a?u-a:s-i});for(const s of o){const[i,u]=C.get(s),a=document.createElementNS("http://www.w3.org/2000/svg","circle");a.setAttribute("cx",String(i)),a.setAttribute("cy",String(u)),a.setAttribute("r","6.5"),a.setAttribute("class","dual-graph-node"),a.setAttribute("data-value",String(s));const c=t.get(s);a.setAttribute("data-step",c==null?"":String(c));const r=document.createElementNS("http://www.w3.org/2000/svg","text");r.setAttribute("x",String(i)),r.setAttribute("y",String(u-9)),r.setAttribute("text-anchor","middle"),r.setAttribute("class","dual-graph-node-label"),r.textContent=String(s),n.appendChild(a),n.appendChild(r)}return n}function St(e){const t=new Set;for(const n of e){if(!S.has(n))continue;t.add(n);const o=n/2,s=n*2;if(Number.isInteger(o)&&S.has(o)&&t.add(o),S.has(s)&&t.add(s),n%2===1){const i=3*n+1;S.has(i)&&t.add(i)}else if((n-1)%3===0){const i=(n-1)/3;i>0&&i%2===1&&S.has(i)&&t.add(i)}}return t}function xt(e){const t=new Set;for(const n of e){if(!$.has(n))continue;t.add(n);const o=m.parentByNode.get(n);o!=null&&t.add(o);const s=m.childrenByNode.get(n)??[];for(const i of s)t.add(i)}if(!t.size){t.add(1);const n=m.childrenByNode.get(1)??[];for(const o of n)t.add(o)}return t}function At(e){if(!e.size)return`0 0 ${ut} ${ct}`;let t=1/0,n=-1/0,o=1/0,s=-1/0;for(const l of e){const[d,h]=N[l];d<t&&(t=d),d>n&&(n=d),h<o&&(o=h),h>s&&(s=h)}const i=D*.9,u=Y*1.1,a=J*2;t=Math.max(t-i,L.minX-a),n=Math.min(n+i,L.maxX+a),o=Math.max(o-u,L.minY-a),s=Math.min(s+u,L.maxY+a);let c=n-t,r=s-o;if(c<180){const l=(180-c)/2;t-=l,n+=l,c=180}if(r<180){const l=(180-r)/2;o-=l,s+=l,r=180}return`${t} ${o} ${c} ${r}`}function Nt(e){if(!e.size)return`0 0 ${m.width} ${m.height}`;let t=1/0,n=-1/0,o=1/0,s=-1/0;for(const r of e){const l=C.get(r);if(!l)continue;const[d,h]=l;d<t&&(t=d),d>n&&(n=d),h<o&&(o=h),h>s&&(s=h)}const i=85,u=70;t=Math.max(0,t-i),o=Math.max(0,o-u),n=Math.min(m.width,n+i),s=Math.min(m.height,s+u);let a=n-t,c=s-o;if(a<250){const r=(250-a)/2;t=Math.max(0,t-r),n=Math.min(m.width,n+r),a=n-t}if(c<220){const r=(220-c)/2;o=Math.max(0,o-r),s=Math.min(m.height,s+r),c=s-o}return`${t} ${o} ${a} ${c}`}function Et(e){const t=document.createElementNS("http://www.w3.org/2000/svg","g");t.setAttribute("class","dual-graph-nodes");for(const{value:n,x:o,y:s}of E){const i=document.createElementNS("http://www.w3.org/2000/svg","circle");i.setAttribute("cx",String(o)),i.setAttribute("cy",String(s)),i.setAttribute("r",String(J)),i.setAttribute("class","dual-graph-node"),i.setAttribute("data-value",String(n));const u=e.get(n);i.setAttribute("data-step",u==null?"":String(u));const a=document.createElementNS("http://www.w3.org/2000/svg","text");a.setAttribute("x",String(o)),a.setAttribute("y",String(s+3)),a.setAttribute("text-anchor","middle"),a.setAttribute("class","dual-graph-node-label"),a.textContent=String(n),t.appendChild(i),t.appendChild(a)}return t}function K(e,t){e.setAttribute("viewBox",t),e.setAttribute("preserveAspectRatio","xMidYMid meet")}function Ct(e){const[t,n,o,s]=e.split(" ").map(Number);return{minX:t,minY:n,width:o,height:s}}function Q(e,t,n,o,s){const i="http://www.w3.org/2000/svg",{minX:u,minY:a,width:c,height:r}=Ct(t),l=u+c*.88,d=a+r*.12,h=document.createElementNS(i,"g");if(h.setAttribute("class","dual-graph-layer-external"),o){const[y,A]=o;h.appendChild(M(l,d,y,A,"dual-graph-edge-external"))}const g=document.createElementNS(i,"circle");g.setAttribute("cx",String(l)),g.setAttribute("cy",String(d)),g.setAttribute("r","7"),g.setAttribute("class","dual-graph-node dual-graph-node-external"),g.setAttribute("data-value",String(n)),g.setAttribute("data-step","0"),h.appendChild(g);const p=document.createElementNS(i,"text");p.setAttribute("x",String(l-10)),p.setAttribute("y",String(d-10)),p.setAttribute("text-anchor","end"),p.setAttribute("class","dual-graph-node-label dual-graph-node-label-external"),p.textContent=s>0?`start ${n} -> +${s} step(s)`:`start ${n}`,h.appendChild(p),e.appendChild(h)}function Mt(e,t,n,o,s,i){e.innerHTML="",K(e,o);const u="http://www.w3.org/2000/svg",a=document.createElementNS(u,"g");a.setAttribute("class","dual-graph-layer-tree");for(const r of n){const[l,d]=C.get(r),h=m.childrenByNode.get(r)??[];for(const g of h){if(!n.has(g))continue;const[p,y]=C.get(g),A=g===r*2?"dual-graph-edge-double":"dual-graph-edge-bridge";a.appendChild(M(l,d,p,y,A))}}e.appendChild(a);const c=document.createElementNS(u,"g");c.setAttribute("class","dual-graph-layer-path");for(const[r,l]of t){const[d,h]=C.get(r),[g,p]=C.get(l);c.appendChild(M(d,h,g,p,"dual-graph-edge-path"))}if(e.appendChild(c),i){const r=i.targetValue!=null?C.get(i.targetValue):null;Q(e,o,i.startValue,r,i.skippedSteps)}e.appendChild(vt(n,s))}function Tt(e,t,n,o,s){e.innerHTML="",K(e,n);const i="http://www.w3.org/2000/svg",u=document.createElementNS(i,"g");u.setAttribute("class","dual-graph-layer-double");for(const[r,l]of ft){const[d,h]=N[r],[g,p]=N[l];u.appendChild(M(d,h,g,p,"dual-graph-edge-double"))}e.appendChild(u);const a=document.createElementNS(i,"g");a.setAttribute("class","dual-graph-layer-bridge");for(const[r,l]of bt){const[d,h]=N[r],[g,p]=N[l];a.appendChild(M(d,h,g,p,"dual-graph-edge-bridge"))}e.appendChild(a);const c=document.createElementNS(i,"g");c.setAttribute("class","dual-graph-layer-pathoverlay");for(const[r,l]of t){const[d,h]=N[r],[g,p]=N[l];c.appendChild(M(d,h,g,p,"dual-graph-edge-path"))}if(e.appendChild(c),s){const r=s.targetValue!=null?N[s.targetValue]:null;Q(e,n,s.startValue,r,s.skippedSteps)}e.appendChild(Et(o))}function It(e){e.innerHTML=rt;const t=e.querySelector("#dual-graph-svg-path"),n=e.querySelector("#dual-graph-svg-structure"),o=e.querySelector("#dual-graph-tooltip"),s=e.querySelector("#dual-graph-note");function i(){o.hidden=!0}function u(c,r,l,d){o.textContent=r?`${c} (step ${r})`:`${c} (step -)`;const h=e.getBoundingClientRect();o.style.left=`${l-h.left+12}px`,o.style.top=`${d-h.top+12}px`,o.hidden=!1}e.addEventListener("mousemove",c=>{const r=c.target;if(!(r instanceof Element)){i();return}const l=r.closest(".dual-graph-node");if(!l){i();return}const d=l.getAttribute("data-value");if(!d){i();return}const h=l.getAttribute("data-step");u(d,h,c.clientX,c.clientY)}),e.addEventListener("mouseleave",i);function a(){const{startN:c}=O(),r=H(c),l=r[0],d=mt(r),h=yt(r),g=wt(r),p=F(r,S),y=F(r,$),A=St(r),T=xt(r),B=At(A),f=Nt(T),b=p!==0?{startValue:l,targetValue:p>0?r[p]:null,skippedSteps:p>0?p:0}:null,w=y!==0?{startValue:l,targetValue:y>0?r[y]:null,skippedSteps:y>0?y:0}:null;Mt(t,h,T,f,g,w),Tt(n,d,B,g,b);const x=d.length>0,v=l!=null&&S.has(l);!x&&l===1?(s.hidden=!1,s.textContent="Starting at 1, there is no Collatz step to draw on this diagram."):!x&&v?(s.hidden=!1,s.textContent="Your starting value is visible, but subsequent Collatz steps quickly leave this finite window. Try a value that stays in this window longer (for example 160, 96, or 48)."):!x&&!v?(s.hidden=!1,s.textContent="This window shows odd roots 1 to 17 with doubling values up to 2500. Choose a starting value from this window to see path segments."):(s.hidden=!0,s.textContent="")}k(()=>a()),a()}et();it(document.getElementById("section-start-input"));It(document.getElementById("section-dual-graph"));
